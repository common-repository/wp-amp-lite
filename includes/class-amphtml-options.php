...
if ( ! class_exists( 'AMPHTML_Options' ) ) {
    ...
    class AMPHTML_Options {
        ...
        public function add_endpoint_settings() {
            ...
            add_settings_field( $this->get( 'endpoint', 'name' ), esc_html__( 'WP AMP Endpoint', 'amphtml' ), array(
                $this,
        ...
        public function sanitize_endpoint( $endpoint ) {
            ...
            if ( ! $endpoint ) {
                add_settings_error( $this->get( 'endpoint', 'name' ), 'endpoint_error', esc_html__( 'Insert a valid endpoint', 'amphtml' ), 'error' );
        ...
        public function custom_link() {
            ...
            if ( $this->get_request_var( 'post' ) && 'edit' == $this->get_request_var( 'action' ) ) {
                $wp_admin_bar->add_menu( array(
                    'parent' => false,
                    'id'     => 'view-amphtml',
                    'title'  => esc_html__( 'View AMP Version', 'amphtml' ),
        ...
        public function admin_bar_menus( $wp_admin_bar ) {
            ...
            if ( ! AMPHTML()->is_excluded_posts_page() ) {
                $wp_admin_bar->add_node( array(
                    'parent' => 'site-name',
                    'id'     => 'visit-amphtml',
                    'title'  => esc_html__( 'Visit AMP Site', 'amphtml' ),
        ...
        public function init_options() {
            ...
            if ( is_admin() || 0 === ( ( $fields  = unserialize( get_transient( 'amphtml_fields' ) ) ) & $options = get_transient( 'amphtml_options' ) ) ) {
        ...
        public function add_amphtml_menu_location() {
            register_nav_menu( self::NAV_MENU, esc_html__( 'AMP Menu', 'amphtml' ) );
            register_nav_menu( self::NAV_MENU_FOOTER, esc_html__( 'AMP Menu Footer', 'amphtml' ) );
        }
        ...
        public function settings_page() {
            ?>
            <div class="wrap">
                <h1><?php esc_html_e( 'WP AMP Settings', 'amphtml' ) ?></h1>
        ...
        public function add_exclude_from_amphtml_metabox() {
            ...
            if ( ! empty( $cpt_selected ) ) {
                ...
                add_meta_box( 'amphtml-featured-image', esc_html__( 'WP AMP featured Image', 'amphtml' ), array(
                    $this,
        ...
        public function display_exclude_options( $object ) {
            ...
            ?>
            <p>
                <label for="amphtml-metabox"><?php esc_html_e( "Disable AMP version of this page", 'amphtml' ) ?></label>
        ...
        public function save_amphtml_meta_box( $post_id, $post, $update ) {
            ...
            if ( isset( $_POST[ 'amphtml-exclude' ] ) ) {
                update_post_meta( $post_id, 'amphtml-exclude', sanitize_text_field( $_POST[ 'amphtml-exclude' ] ) );
            } else {
            ...
            if ( ! isset( $_POST[ 'amphtml-exclude' ] ) ) {
                ...
                if ( isset( $_POST[ 'amphtml-custom-title' ] ) && $options[ 'amphtml-override-title' ] ) {
                    update_post_meta( $post_id, 'amphtml-custom-title', sanitize_text_field( $_POST[ 'amphtml-custom-title' ] ) );
                }

                if ( isset( $_POST[ 'amphtml-custom-content' ] ) && $options[ 'amphtml-override-content' ] ) {
                    update_post_meta( $post_id, 'amphtml-custom-content', sanitize_text_field( $_POST[ 'amphtml-custom-content' ] ) );
                }
            }
        }
