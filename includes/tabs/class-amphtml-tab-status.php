...
if ( ! class_exists( 'AMPHTML_Tab_Status' ) ) {
        ...
        public function get_fields() {
            return array(
                'troubleshooting' => array(
                    'id'               => 'system_status',
                    'title'            => esc_html__( 'System Status', 'amphtml' ),
        ...
        public function display_system_info() {
            ...
            <table class="widefat striped" cellspacing="0">
                <thead>
                    <tr>
                        <th colspan="3"
                            data-export-label="Server Environment"><?php esc_html_e( 'Server Environment', 'amphtml' ); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td data-export-label="Server Info"><?php esc_html_e( 'Server Info', 'amphtml' ); ?>:</td>
                        <td><?php echo $sysinfo[ 'server_info' ]; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="PHP Version"><?php esc_html_e( 'PHP Version', 'amphtml' ); ?>:</td>
                        <td><?php
                    ...
                    <tr>
                        <td data-export-label="WP Version"><?php esc_html_e( 'WP Version', 'amphtml' ); ?>:</td>
                        <td><?php
            ...
            <?php if ( $sysinfo[ 'wc_version' ] ): ?>
                        <tr>
                            <td data-export-label="WooCommerce Version"><?php esc_html_e( 'WooCommerce Version', 'amphtml' ); ?>:</td>
                            <td><?php
            ...
            <?php endif; ?>
                    <tr>
                        <td data-export-label="ABSPATH"><?php esc_html_e( 'ABSPATH', 'amphtml' ); ?>:</td>
                        <td><?php echo '<code>' . $sysinfo[ 'abspath' ] . '</code>'; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="MySQL Version"><?php esc_html_e( 'MySQL Version', 'amphtml' ); ?>:</td>
                        <td><?php echo $sysinfo[ 'mysql_ver' ]; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="allow_url_fopen"><?php esc_html_e( 'allow_url_fopen', 'amphtml' ); ?>:</td>
                        <td><?php
                            if ( $sysinfo[ 'allow_url_fopen' ] == true ) {
                    ...
                    <tr>
                        <td data-export-label="cURL Version"><?php esc_html_e( 'cURL Version', 'amphtml' ); ?>:</td>
                        <td><?php
                            if ( function_exists( 'curl_version' ) ) {
                                $curl_version = curl_version();
                                echo $curl_version[ 'version' ] . ', ' . $curl_version[ 'ssl_version' ];
                            } else {
                                esc_html_e( 'N/A', 'amphtml' );
                            }
                            ?></td>
                    </tr>
                    <?php
            ...
            <p><?php esc_html_e( 'See WordPress minimum requirements', 'amphtml' ) ?> <a
                    href="https://wordpress.org/about/requirements/" target="_blank"><?php esc_html_e( 'here', 'amphtml' ) ?></a>.
            </p>
            <?php
        }
