...
if ( ! class_exists( 'AMPHTML' ) ) :
    ...
    class AMPHTML {
        ...
        public function register_styles() {
            ...
            wp_register_style( 'amphtml-admin-ui-css', $this->get_amphtml_url() . 'css/jquery-ui.css' );
        ...
        public function get_search_redirect_url() {
            if ( get_query_var( 's' ) ) {
                $post_type = $_GET[ 'post_type' ] ? '?post_type=' . sanitize_text_field( $_GET[ 'post_type' ] ) : '';
        ...
        protected function _parse_request( $wp, $extra_query_vars ) {
            ...
            foreach ( $wp->public_query_vars as $wpvar ) {
                if ( isset( $wp->extra_query_vars[ $wpvar ] ) ) {
                    ...
                    $wp->query_vars[ $wpvar ] = sanitize_text_field( $_POST[ $wpvar ] );
                } elseif ( isset( $_GET[ $wpvar ] ) ) {
                    $wp->query_vars[ $wpvar ] = sanitize_text_field( $_GET[ $wpvar ] );
