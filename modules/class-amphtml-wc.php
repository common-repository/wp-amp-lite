...
if ( ! class_exists( 'AMPHTML_WC' ) ) {
    ...
    class AMPHTML_WC {
        ...
        public function add_wc_options_tab( $tab_list ) {
            $tab_list[ 'wc' ] = esc_html__( 'WooCommerce', 'amphtml' );
        ...
        public function add_colors( $fields, $tab, $section ) {
            $fields[] = array(
                ...
                'title'                 => esc_html__( 'Add to Cart Button', 'amphtml' ),
                'default'               => '#88457b',
        ...
        public function add_to_cart_ajax() {
            ...
            if ( $passed_validation && false !== WC()->cart->add_to_cart( $product_id, $quantity, $variation_id, $variation ) && 'publish' === $product_status ) {
                ...
                $data = array(
                    'errors' =>
                    array(
                        'error_detail' => esc_html__( 'error text', 'amphtml' ), )
                );
            }
            wp_send_json( $data );
            die;
